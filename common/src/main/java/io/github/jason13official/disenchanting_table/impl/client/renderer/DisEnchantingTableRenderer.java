...
public class DisEnchantingTableRenderer
    implements BlockEntityRenderer<DisEnchantingTableTile, DisEnchantingTableRenderer.RenderState> {
  ...
  @Override
  public void extractRenderState(DisEnchantingTableTile tile, RenderState state,
      float f, Vec3 vec3, ModelFeatureRenderer.@Nullable CrumblingOverlay overlay) {
